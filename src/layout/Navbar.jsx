  ...
  return (
    <div className="bg-white dark:bg-slate-950">
      ...
      <div className={`navbar-menu relative z-50 ${!isOpen && "hidden"}`}>
        ...
        <nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white dark:bg-slate-950 border-r dark:border-slate-900 overflow-y-auto">
          ...
          <div className="mt-auto">
            {currentUser?.email ? (
              ...
              <div className="pt-6 flex gap-2 justify-center">
                <button
                  className="block px-4 py-3 mb-3  text-xs text-center font-semibold leading-none bg-gray-50 dark:text-black hover:bg-gray-100 rounded-xl"
                  onClick={() => {
                    navigate("/login");
                    setIsOpen(!isOpen);
                  }}
